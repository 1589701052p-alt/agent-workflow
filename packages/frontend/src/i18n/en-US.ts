...
export const enUS: Resources = {
  nav: {
    ...
    dynamicWorkflowSpaces: 'Dynamic spaces',
    tasks: 'Tasks',
    scheduled: 'Scheduled',
    reviews: 'Reviews',
    clarify: 'Clarify',
  ...
  dynamicWorkflowSpaces: {
    title: 'Dynamic workflow spaces',
    newButton: 'New space',
    emptyList: 'No dynamic workflow spaces yet. Create one to orchestrate an agent pool.',
    colName: 'Name',
    colPool: 'Pool',
    colDescription: 'Description',
    colUpdated: 'Updated',
    deleteTitle: 'Delete space',
    deleteBody: 'Delete dynamic workflow space "{{name}}"? Launched tasks keep their snapshot.',
    newTitle: 'New dynamic workflow space',
    createButton: 'Create',
    fieldName: 'Name',
    fieldNameHint: 'lowercase, digits, dash/underscore; used in the URL.',
    fieldDescription: 'Description',
    loading: 'Loading space…',
    sectionBasics: 'Basics',
    sectionPool: 'Agent pool',
    poolHint:
      'The agents the built-in orchestrator may compose into a workflow. Each may be used any number of times; the non-empty requirement is enforced at launch.',
    poolAddPlaceholder: 'agent name',
    poolAddButton: 'Add',
    poolEmpty: 'No agents in the pool yet.',
    poolRemove: 'Remove',
    poolAgentMissing: 'agent not found (it may have been deleted) — resolved at launch',
    errors: {
      nameRequired: 'name is required',
      nameInvalid: 'lowercase + digits + dash/underscore, ≤128 chars',
    },
  },
  agentForm: {
    sectionBasics: 'Basics',
