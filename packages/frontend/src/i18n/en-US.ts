...
export const enUS: Resources = {
  ...
  taskTimeline: {
    title: 'Timeline',
    filterAll: 'All',
    filterHumanInput: 'Input',
    filterNodeOutput: 'Output',
    filterClarify: 'Q&A',
    filterReview: 'Review',
    empty: 'No interactions yet',
    loadError: 'Failed to load interaction timeline',
    truncated: 'Showing the most recent {{n}} interactions',
    jumpSession: 'View full session',
    jumpClarify: 'View clarify detail',
    jumpReview: 'View review detail',
    kindHumanInput: 'Human input',
    kindNodeOutput: 'Node output',
    kindClarifyQuestion: 'Clarify question',
    kindClarifyAnswer: 'Human answer',
    kindReviewDecision: 'Review decision',
    actorHuman: 'Human',
    unansweredHint: 'Awaiting answer',
