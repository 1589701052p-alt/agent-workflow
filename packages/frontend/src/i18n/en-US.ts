...
export const enUS: Resources = {
  ...
  workgroups: {
    ...
    modeHintLeaderWorker:
      'The leader dispatches work to workers turn by turn; pick one agent member as leader.',
    modeHintFreeCollab:
      'Leaderless free collaboration; the three collaboration switches are forced on.',
    memberColType: 'Type',
    memberColRef: 'Reference',
    memberColDisplayName: 'Display name',
    memberColRole: 'Role',
    memberColLeader: 'Leader',
    memberTypeAgent: 'Agent',
    memberTypeHuman: 'Human',
    memberTypeAria: 'Member {{index}} type',
    memberUserAria: 'Member {{index}} platform user',
    memberAgentPlaceholder: 'Agent name (may not exist yet)',
    memberUserPlaceholder: 'Pick a platform user',
    memberDisplayNamePlaceholder: 'Unique in the group; no @, comma or whitespace',
    memberRolePlaceholder: 'Role inside the group (dispatch hint)',
    memberFallbackLabel: 'member {{index}}',
    leaderRadioAria: 'Make {{name}} the leader',
    ...
    errors: {
      ...
      leaderRequired: 'Leader-Worker mode requires one agent member as leader.',
