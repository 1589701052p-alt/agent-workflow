...
describe('RFC-054 W1-6 — rolling upgrade from old home reaches HEAD + runs toy task', () => {
  ...
  test('HEAD journal has 33 entries (sanity — locks the freeze target indices)', () => {
    ...
    // RFC-061 PR-A T1 bumped to 33 with migration 0033_rfc061_events_projections.
    expect(HEAD_TOTAL_MIGRATIONS).toBe(33)
  })
