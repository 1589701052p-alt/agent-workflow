...
| T9 | AR-14 | fail-safe survivor-kill + 持久化 spawn 身份（3-of-3 才杀，歧义告警不强杀） | M | 生效 |
...
| T16 | AR-20 | 廉价可观测：boot-reap awaiting_* alert / `/diagnose` 跑 stuck / doctor 生命周期检查 / DiagnoseTable fallback | S | 生效 |
