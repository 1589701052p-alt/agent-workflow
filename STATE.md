...
**最近更新**：2026-05-14（M5 进行中 — P-5-01 events archival + P-5-02 backup + P-5-03 stage 1 i18n scaffold）
...
M5 打磨       [2.5/12]    ← 进行中（P-5-01 + P-5-02 + P-5-03 stage 1）
```
...
P-5-01 + P-5-02 闭合，P-5-03 stage 1 完成（脚手架 + nav/auth/settings）。后续工作：
